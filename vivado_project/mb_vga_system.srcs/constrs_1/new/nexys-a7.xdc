...
set_property IOB FALSE [get_cells {vga_mb_system_i/ethernet/U0/IOFFS_GEN2.RER_FF}]
set_property IOB FALSE [get_cells {vga_mb_system_i/ethernet/U0/IOFFS_GEN[3].RX_FF_I}]
set_property IOB FALSE [get_cells {vga_mb_system_i/ethernet/U0/IOFFS_GEN[0].RX_FF_I}]
set_property IOB FALSE [get_cells {vga_mb_system_i/ethernet/U0/IOFFS_GEN[0].TX_FF_I}]
set_property IOB FALSE [get_cells {vga_mb_system_i/ethernet/U0/IOFFS_GEN[1].RX_FF_I}]
...
create_clock -period 10.000 -name sys_clk -waveform {0.000 5.000} -add [get_ports sys_clock]
...
### RGB LEDs
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports {rgb_leds_tri_o[5]}]
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports {rgb_leds_tri_o[4]}]
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {rgb_leds_tri_o[3]}]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports {rgb_leds_tri_o[2]}]
set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports {rgb_leds_tri_o[1]}]
