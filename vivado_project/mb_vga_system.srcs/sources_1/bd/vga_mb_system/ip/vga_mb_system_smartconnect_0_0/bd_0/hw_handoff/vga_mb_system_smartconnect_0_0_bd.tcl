...
proc create_hier_cell_switchboards { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.M01_S05_CONNECTIVITY {0} \
   CONFIG.M01_S06_CONNECTIVITY {0} \
   CONFIG.M01_S07_CONNECTIVITY {0} \
   CONFIG.M01_S08_CONNECTIVITY {0} \
   CONFIG.M01_S09_CONNECTIVITY {0} \
   CONFIG.M01_S10_CONNECTIVITY {0} \
   CONFIG.M02_S00_CONNECTIVITY {1} \
   CONFIG.M02_S01_CONNECTIVITY {0} \
   CONFIG.M02_S02_CONNECTIVITY {0} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_SC_AR_4 [get_bd_intf_pins m01_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M01_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_5 [get_bd_intf_pins m02_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M02_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_6 [get_bd_intf_pins m03_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M03_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_7 [get_bd_intf_pins m04_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M04_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_8 [get_bd_intf_pins m05_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M05_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_9 [get_bd_intf_pins m06_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M06_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_10 [get_bd_intf_pins m07_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M07_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_11 [get_bd_intf_pins m08_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M08_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_12 [get_bd_intf_pins m09_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M09_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_13 [get_bd_intf_pins m10_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M10_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_R_4 [get_bd_intf_pins m01_nodes/S_SC_R] [get_bd_intf_pins m01_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_5 [get_bd_intf_pins m02_nodes/S_SC_R] [get_bd_intf_pins m02_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_6 [get_bd_intf_pins m03_nodes/S_SC_R] [get_bd_intf_pins m03_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_7 [get_bd_intf_pins m04_nodes/S_SC_R] [get_bd_intf_pins m04_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_8 [get_bd_intf_pins m05_nodes/S_SC_R] [get_bd_intf_pins m05_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_9 [get_bd_intf_pins m06_nodes/S_SC_R] [get_bd_intf_pins m06_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_10 [get_bd_intf_pins m07_nodes/S_SC_R] [get_bd_intf_pins m07_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_11 [get_bd_intf_pins m08_nodes/S_SC_R] [get_bd_intf_pins m08_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_12 [get_bd_intf_pins m09_nodes/S_SC_R] [get_bd_intf_pins m09_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_13 [get_bd_intf_pins m10_nodes/S_SC_R] [get_bd_intf_pins m10_sc2axi/M_SC_R]
